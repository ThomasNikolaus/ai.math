  ...
  return (
    <>
      ...
      <div className="discussion-introduction prose">
        ...
        <p>
          {de
            ? "Wir setzen auf eine Diskussion auf Augenhöhe. Lasst uns reflektiert und mit Empathie diskutieren! Ein Postdoc in der Bewerbungsphase verspürt mehr Druck, KI einzusetzen, um schneller zu arbeiten, als ein Professor mit einer gesicherten Dauerstelle. Frisch gebackene Eltern haben nach zahlreichen schlaflosen Nächten andere Voraussetzungen, sich in eine Aussage aus einem anderen Gebiet einzuarbeiten, die sie in ihrem Paper verwenden, als eine Professorin mit viel Zeit und Schlaf. Menschen reagieren unterschiedlich auf neue Entwicklungen: Einige sind skeptisch und vorsichtig, andere neugierig und gespannt. Geprägt durch unsere Persönlichkeiten und Erfahrungen gehen wir unterschiedlich mit Unsicherheit um. Gerade wenn wir über den generellen Einsatz von KI oder unsere Erwartungen an das Verständnis von Resultaten diskutieren, sollten wir daher viel Verständnis für die Lebensumstände unserer Diskussionspartner:innen aufbringen."
            : "We seek a discussion on equal terms. Let us discuss thoughtfully and with empathy! A postdoc applying for jobs feels more pressure to use AI to work faster than a professor with a secure permanent position. After many sleepless nights, new parents face different conditions when working to understand a statement from another field that they use in their paper than a professor with plenty of time and sleep. People react differently to new developments: some are sceptical and cautious, others curious and excited. Different people deal with uncertainty differently, shaped by our personalities and experiences. Especially when discussing whether to use AI in general or what understanding of results we expect, we should therefore show considerable understanding for our discussion partners’ circumstances."}
        </p>
        <p>
          {de
