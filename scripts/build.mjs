...
// Crawlers need access to the pages to see noindex; disallowing crawling would hide it.
generated.set("robots.txt", `User-agent: *\nAllow: /\n\n# Indexing remains disabled by noindex meta tags on all HTML pages.\nSitemap: ${absolute("sitemap.xml")}\n`);
